...
Before starting, I copy the root .env.example to airflow/.env and fill in SNOWFLAKE_ACCOUNT, SNOWFLAKE_USER, SNOWFLAKE_PASSWORD, SNOWFLAKE_ROLE, SNOWFLAKE_WAREHOUSE, SNOWFLAKE_DATABASE, SNOWFLAKE_SCHEMA, BIGQUERY_PROJECT, and GOOGLE_APPLICATION_CREDENTIALS.
