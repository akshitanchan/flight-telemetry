-- BigQuery DDL: gold_airport_congestion
...
-- Cluster: airport_icao per C3 locked contract.

CREATE OR REPLACE TABLE `flight_telemetry.gold_airport_congestion`
(
...
CLUSTER BY airport_icao
OPTIONS (
    description = 'Airport congestion aggregates per time window. Contract v1.0.0.'
);
